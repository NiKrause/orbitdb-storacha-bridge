...
// Create default logger for the ucan-delegation app
export const logger = libp2pLogger("libp2p:orbitdb-storacha:ucan-delegation");
...
export function createChildLogger(namespace) {
  return libp2pLogger(`libp2p:orbitdb-storacha:ucan-delegation:${namespace}`);
}
