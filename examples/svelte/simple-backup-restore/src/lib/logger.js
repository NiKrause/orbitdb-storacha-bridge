...
// Create default logger for the simple-backup-restore app
export const logger = libp2pLogger("libp2p:orbitdb-storacha:simple-backup-restore");
...
export function createChildLogger(namespace) {
  return libp2pLogger(`libp2p:orbitdb-storacha:simple-backup-restore:${namespace}`);
}
