 ...
 * @param {string} [options.gateway] - retrieval gateway, e.g. `https://<name>.mypinata.cloud`.
 *   The account's dedicated gateway is strongly preferred: the shared one rate limits with
 *   429s, which are waited out, but slowly
